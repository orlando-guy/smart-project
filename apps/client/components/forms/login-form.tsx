...
import { LoginUserSchema, LoginUserInput } from "@repo/shared";
        ...
        <Card className="w-full sm:max-w-md py-8 shadow-soft-medium ring-0 z-20">
            <CardHeader>
                ...
                <CardDescription className="text-[1rem] text-(--text-foreground) leading-7 font-bold my-6 text-center">
                    ...
                    {isExpired && (
                        <div className="mb-4 p-3 text-sm text-amber-800 bg-amber-50 rounded border border-amber-200">
                            Votre session a expiré. Veuillez vous reconnecter pour accéder au Kanban.
                        </div>
                    )}
                </CardDescription>
            </CardHeader>
